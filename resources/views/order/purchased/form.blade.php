                            ...
                            @if($loggedUser->isAdmin())
                                <div class="col-md-6 col-lg-6 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <select name="customer_id" style="width: 100%;" class="form-control customers">
                                            @if($order->customer_id !== null)
                                                <option
                                                    value="{{$order->customer_id}}">{{$order->customer->name}}</option>
                                            @endif
                                        </select>
                                    </div>
                                </div>
            ...
            <div class="col-md-10 purchase-order" style="margin-top:20px;">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <button class="btn btn-info" v-on:click="AddPurchaseOrder" style="float:right">Add purchase
                            order line
                        </button>
                    </div>
                    <div class="card-body">
                        <div class="row-purchase-order">
                            ...
                            <table class="table">
                                ...
                                <tr v-for="(purchase_order, index) in purchase_order_rows">
                                    ...
                                    <td>
                                        <div class="form-group">
                                            <input :name="'quantity['+index+']'" type="text"
                                                   :value="purchase_order.quantity" class="form-control">
                                        </div>
                                    </td>

                                    <td>
                                        <div class="form-group">
                                            <input :name="'sku['+index+']'" type="text" disabled
                                                   :value="purchase_order.sku" class="form-control">
                                        </div>
                                    </td>

                                    <td>
                                        <div class="form-group">
                                            <select :name="'product['+index+']'" :id="'product_'+index"
                                                    style="width:100%;" class="products">
                                                <option v-if="purchase_order.product_id"
                                                        :value="purchase_order.product_id">
                                    ...
                                    <td>
                                        <div class="form-group">
                                            <input :name="'batch['+index+']'" type="text" v-model="purchase_order.batch"
                                                   class="form-control">
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="form-group">
                                            <input :name="'expire_date['+index+']'" type="text"
                                                   :id="'expire_date_'+index" :value="purchase_order.expire_date"
                                                   class="form-control expire_date">
                                        </div>
                                    </td>

                                    <td>
                                        <a v-on:click="removePurchaseOrder(index)"
